...
public class BookDirectoryTestSuite {
    ...
    public void testZeroBooksBorrowed () {
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser user = new LibraryUser("Henry", "James", "123456");
        List<Book> resultListOf0Books = new ArrayList<Book>();
        when(libraryDatabaseMock.listBooksInHandsOf(user)).thenReturn(resultListOf0Books);

        List <Book> theListOf0BorrowedBooks = bookLibrary.listBooksInHandsOf(user);
    ...
    public void testOneBookBorrowed () {
        ...
        List <Book> theListOf1BorrowedBook = bookLibrary.listBooksInHandsOf(user);

        assertEquals(1,theListOf1BorrowedBook.size());
    }
    @Test
    public void testFiveBooksBorrowed () {
        ...
        List <Book> theListOf5BorrowedBooks = bookLibrary.listBooksInHandsOf(user);
